...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cartopy_offlinedata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cartopy_offlinedata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cartopy_offlinedata
# for installing globally
pixi global install cartopy_offlinedata
```
...
It is possible to list all of the versions of `cartopy_offlinedata` available on your platform:
...
```
pixi search cartopy_offlinedata --channel conda-forge
```
